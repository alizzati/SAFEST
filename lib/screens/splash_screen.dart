      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFF7E57C2), // Purple lighter
              Color(0xFF673AB7), // Purple medium
              Color(0xFF512DA8), // Purple dark
              Color(0xFF4527A0), // Purple darker
            ],
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: RadialGradient(
                                  colors: [
                                    Colors.white.withOpacity(0.3 * (1 - _glowController.value)),
                                    Colors.transparent,
                                  ],
                                ),
                              ),
        ...
        return Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Colors.white.withOpacity(0.05 * (1 - _particleController.value)),
                Colors.transparent,
